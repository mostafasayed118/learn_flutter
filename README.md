...
![Status](https://img.shields.io/badge/All_Projects-9%20✅-blue)

> A collection of **9 Flutter projects** — from Hello World to interactive apps — each with its own source code, assets, and design system documentation. All projects completed!
...
| 7 | [Chat App](./chat_app/) | ✅ Completed | Minimal starter scaffold for chat functionality |
...
- `DESIGN.md` — Design system documentation (colors, typography, layout, components)
...
Every project has a `DESIGN.md` file following the [awesome-design-md](https://github.com/VoltAgent/awesome-design-md) format. These files define:
